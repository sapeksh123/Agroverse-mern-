      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mt-6">
            ...
            <p className="text-gray-600 mb-4">Have questions about this equipment? Contact the owner directly.</p>
            <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-2 px-4 rounded transition-colors">
              Message Owner
            </button>
          </div>
        </div>
